...
public class Utilisation extends JFrame{
	...
	private JMenuBar createMenuBar() {
		...
		JMenu menu2 = new JMenu("Players");     //           <-------
			...
			JMenuItem player4 = new JMenuItem(StartGame.players.get(4).pseudo);
			player4.addActionListener(this::notavaible2);
			menu2.add(player4);
	...
	public class TwoPlayersUsePanel extends JPanel{
		...
		private static final long serialVersionUID = 1L;
			...
			g.drawString("UTILISATION DEUX JOUEURS :", 156, 150); 
			Font  font1 = new Font("Arial",Font.BOLD,18);
			g.setFont(font1);
			g.drawString("-Pour commencer la partie veuillez selectionner " + StartGame.players.get(0).pseudo +  " dans la catégorie 'Players'.",30, 200);
			g.drawString("-Ensuite, dans la catégorie Actions , vous pouvez chosir un domino , placer votre roi,",30, 230);
			g.drawString("selectioner l'orientation du domino, placer le domino...",100, 260);
			g.drawString("-Pour chaque action souhaité , une fenêtre secondaire va s'ouvrir pour sélectionner une",30, 290);
			...
			g.drawString("-Pour changer de plateau correpondant à chaque joueur , il suffit juste de selectionner le",30, 380);
			...
			g.drawString("-Il est possible de quitter le jeu en allant dans 'Menu' et en cliquant sur 'Exit'.",30, 500);
